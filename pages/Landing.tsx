...
import { ArrowRight, Moon, Wind, Thermometer, Battery, Activity, Smile } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" onClick={() => navigate('/auth')} icon={<ArrowRight className="w-5 h-5" />}>
      ...
      <section id="features" className="py-24 bg-white relative">
       ...
       <section className="py-24 relative overflow-hidden">
         ...
         <div className="max-w-4xl mx-auto px-4 relative z-10 text-center">
            ...
            <Button size="lg" className="bg-white text-brand-900 hover:bg-brand-50" onClick={() => navigate('/auth')}>
